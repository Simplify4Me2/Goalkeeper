...
namespace GoalKeeper.Stats.Domain.UnitTests
{
    public class LeagueTests
    {
        ...
        public void League_Table_MatchLost_ReturnsZeroPoints()
        {
            ...
            var matches = new List<PlayedMatch>
            {
                new PlayedMatch(1, testTeam, awayTeam1, new Score(3, 5), new DateTime(), 1)
            };
            var league = new League("CBF", teams, matches);
        ...
        public void League_Table_MatchWon_ReturnsThreePoints()
        {
            ...
            var matches = new List<PlayedMatch>
            {
                new PlayedMatch(1, testTeam, awayTeam1, new Score(5, 0), new DateTime(), 1)
            };
            var league = new League("CBF", teams, matches);
        ...
        public void League_Table_MatchDrawn_ReturnsOnePoints()
        {
            ...
            var matches = new List<PlayedMatch>
            {
                new PlayedMatch(1, testTeam, awayTeam1, new Score(0, 0), new DateTime(), 1)
            };
            var league = new League("CBF", teams, matches);
        ...
        public void League_Table_MatchDrawnAndMatchWon_ReturnsFourPoints()
        {
            ...
            var matches = new List<PlayedMatch>
{
                new PlayedMatch(1, testTeam, otherTeam, new Score(1, 1), new DateTime(), 1),
                new PlayedMatch(2, otherTeam, testTeam, new Score(0, 1), new DateTime(), 1)
            };
            var league = new League("CBF", teams, matches);
        ...
        public void League_Table_ThreeMatches_WinDrawLoss_ReturnsFourPoints()
        {
            ...
            {
                new PlayedMatch(1, testTeam, awayTeam1, new Score(5, 0), new DateTime(), 1),
                new PlayedMatch(2, awayTeam2, testTeam, new Score(2, 2), new DateTime(), 1),
                new PlayedMatch(3, testTeam, awayTeam1, new Score(2, 3), new DateTime(), 1),
            };
            var league = new League("CBF", teams, matches);
        ...
        public void League_Table_OrdersDescendingByPoints()
        {
            ...
            var matches = new List<PlayedMatch>
            {
                new PlayedMatch(1, team1, team2, new Score(0, 5), new DateTime(), 1),
                new PlayedMatch(2, team3, team4, new Score(1, 2), new DateTime(), 1),
                new PlayedMatch(3, team3, team1, new Score(2, 3), new DateTime(), 2),
                new PlayedMatch(4, team4, team2, new Score(2, 3), new DateTime(), 2),
                new PlayedMatch(5, team1, team4, new Score(1, 0), new DateTime(), 3),
                new PlayedMatch(6, team2, team3, new Score(2, 1), new DateTime(), 3),
            };
            var league = new League("CBF", teams, matches);
