...
VALUES
  ...
  (@Anderlecht    , 1, @Gent			, 1, 5, '2021-09-23 20:45:00.0000000', GETDATE(), 'Seed', GETDATE(), 'Seed'),
  ...
  (@Kortrijk      , 1, @Gent			, 0, 8, '2021-09-19 21:00:00.0000000', GETDATE(), 'Seed', GETDATE(), 'Seed'),

  (@ClubBrugge    , 1, @OHL				, 1, 9, '2021-09-24 20:45:00.0000000', GETDATE(), 'Seed', GETDATE(), 'Seed'),
  (@Beerschot     , 0, @Eupen			, 3, 9, '2021-09-25 16:15:00.0000000', GETDATE(), 'Seed', GETDATE(), 'Seed'),
  (@ZulteWaregem  , 2, @Kortrijk		, 2, 9, '2021-09-25 18:30:00.0000000', GETDATE(), 'Seed', GETDATE(), 'Seed'),
  (@StandardLuik  , 1, @STVV			, 2, 9, '2021-09-25 20:45:00.0000000', GETDATE(), 'Seed', GETDATE(), 'Seed'),
  (@Union         , 1, @Antwerp			, 2, 9, '2021-09-26 13:30:00.0000000', GETDATE(), 'Seed', GETDATE(), 'Seed'),
  (@Gent          , 2, @CercleBrugge	, 1, 9, '2021-09-26 16:00:00.0000000', GETDATE(), 'Seed', GETDATE(), 'Seed'),
  (@Oostende      , 2, @Anderlecht		, 2, 9, '2021-09-26 18:30:00.0000000', GETDATE(), 'Seed', GETDATE(), 'Seed'),
  (@Genk          , 3, @Seraing			, 0, 9, '2021-09-26 21:00:00.0000000', GETDATE(), 'Seed', GETDATE(), 'Seed'),
  (@Charleroi     , 0, @Mechelen		, 2, 9, '2021-09-26 21:00:00.0000000', GETDATE(), 'Seed', GETDATE(), 'Seed'),
