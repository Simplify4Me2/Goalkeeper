    ...
    public class GetTeamByIdQueryHandlerTests
    {
        ...
        public GetTeamByIdQueryHandlerTests()
        {
            ...
            _repository.Setup(x => x.GetTeamById(It.IsAny<long>(), CancellationToken.None))
                .ReturnsAsync(new Domain.Entities.Team(12, "TeamName", new List<Domain.Entities.Player>() { new Domain.Entities.Player(1, "Pico", "Coppens", new DateTime(), new DateTime(), null, 9, "ATT"), new Domain.Entities.Player(2, "Xavier", "Waterslaegers", new DateTime(), new DateTime(), null, 1, "GK") } ));
